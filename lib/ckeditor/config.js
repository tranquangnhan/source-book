...
CKEDITOR.editorConfig = function(config) {
    ...
    config.filebrowserBrowseUrl = 'https://liengtam123.tk/lib/ckfinder/ckfinder.html';
    config.filebrowserUploadUrl = 'https://liengtam123.tk/lib/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
