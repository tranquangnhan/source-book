    ...
    <section class="wrapper">
        ...
        <div class="container">
            ...
            <div class="text">
              ...
              " style="
    display: none;
">From hard-working progress of Wheee and his team with help of the delay salary and rush from company owns this web</p>
                <?php
                  require_once "../../system/config.php";
                ?>
                    <p>Uh oh! Có vẻ mục bạn chọn đang lỗi hoặc không tồn tại. <br>Quay trở lại trang chủ nếu bạn muốn!</p>
